...
test_that("expectation_moment_match with model works", {
  ...
  ex_mm <- expectation_moment_match(prop_sample,
...
test_that("expectation_moment_match.stanfit works", {
  ...
  ex_mm <- expectation_moment_match.stanfit(x = fit,
                                            log_prob_target_draws_fun = target_density,
                                            expectation_fun =  function(draws, ...) {
                                              draws})
...
test_that("expectation_moment_match.stanfit works with obs_weights formulation", {
